  ...
  <div class="price__cards">
    <div class="card">
      <div class="card__side card__side--front">
        <figure>
          <img
            :src="require('../../assets/img/homecards/pictures/' + imgName)"
            alt="dirty computer"
          />
          <figcaption>{{ cardHeader }}</figcaption>
        </figure>
        <div class="card__side--details">
          <ul>
            <li v-for="(details, index) in cardDetails" :key="details + index">
      ...
      <div class="card__side card__side--back">
        <small>from &#163;20</small>
        <router-link :to="url">Learn More</router-link>
      </div>
    </div>
  </div>
</template>
